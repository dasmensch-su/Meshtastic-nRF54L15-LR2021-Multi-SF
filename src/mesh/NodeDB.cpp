...
#ifdef ARCH_NRF54L15
extern "C" int nvs_load_proto(const char *, size_t, size_t, const pb_msgdesc_t *, void *);
extern "C" bool nvs_save_proto(const char *, size_t, const pb_msgdesc_t *, const void *);
#endif
