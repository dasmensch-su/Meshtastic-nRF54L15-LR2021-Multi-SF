...
static void serialEnter()
{
    ...
    // On ESP32, serial and BLE share a radio — disable BLE to avoid contention.
    // On nRF54L15 (and future LR2021-based boards with separate BLE hardware),
    // serial and BLE are independent peripherals, so keep BLE advertising active.
    // If an ESP32+LR2021 board is added, gate this on ARCH_ESP32 instead of !ARCH_NRF54L15.
